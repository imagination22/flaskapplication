...
engine = create_engine("postgresql://postgres:shubham@localhost:5432/postgres")
...
def student():
    ...
    db.execute(
        "INSERT INTO student VALUES (:sid, :fname, :lname, :dob, :age, :gender, :phno, :house_no, :building, :city, :course_id, :dept_id)",
        {
            "sid": sid,
            "fname": fname,
            "lname": lname,
...
def faculty():
    ...
    db.execute(
        "INSERT INTO faculty  VALUES (:fid, :fname, :lname, :dob, :gender, :salary, :designation, :course_id, :dept_id, :project_id)",
        {
            "fid": fid,
            "fname": fname,
            "lname": lname,
...
def course():
    ...
    db.execute(
        "INSERT INTO course VALUES (:course_id, :name)",
...
def project():
    ...
    db.execute(
        "INSERT INTO project VALUES (:project_id, :project_name)",
...
def per_project():
    ...
    db.execute(
        "INSERT INTO per_project VALUES (:fid, :project_id, :start_date, :no_of_hours)",
        {
            "fid": fid,
            "project_id": project_id,
